...
use MultiFlexi\Ui\CredentialType\RaiffeisenBank;
...
class RaiffeisenBankTest extends TestCase
{
    ...
    {
        $this->assertTrue(class_exists(RaiffeisenBank::class));
    }

    public function testExtendsCredentialFormHelperPrototype(): void
    {
        $reflection = new \ReflectionClass(RaiffeisenBank::class);
    ...
    {
        $this->assertTrue(method_exists(RaiffeisenBank::class, 'finalize'));
    }
}
